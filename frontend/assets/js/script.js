...
const HONORE_TRANSLATIONS = {
  en: {
    ...
    "prof-current": "I currently serve as a teacher at <a href=\"https://rukaramodelschool.com/\" target=\"_blank\" rel=\"noopener noreferrer\">Rukara Model School of Sciences and Mathematics</a> and I am a student of Computer Science and Physics Education at <a href=\"https://ulk.ac.rw\" target=\"_blank\" rel=\"noopener noreferrer\">Kigali Independent University (ULK), Gisenyi Campus</a>.",
    "prof-trainer": "I also work as an ICT Trainer at <a href=\"https://www.pisquareltd.com/\" target=\"_blank\" rel=\"noopener noreferrer\">PiSquare</a> with the support of <a href=\"https://edify.org\" target=\"_blank\" rel=\"noopener noreferrer\">Edify</a>, where I train teachers and students in digital skills and technology integration. In addition, I facilitate Continuous Professional Development (CPD) at my school, helping teachers integrate ICT into teaching and learning.",
    "prof-training": "I have participated in several professional trainings including the Primary Teaching Residency Program Pilot (<a href='https://www.mineduc.gov.rw/news-detail/primary-teacher-residency-pilot-program-for-ttcs-launched' target='_blank'>Read More</a>), facilitated by <a href=\"https://www.fsu.edu\" target=\"_blank\" rel=\"noopener noreferrer\">Florida State University</a>, <a href=\"https://bridge2rwanda.org\" target=\"_blank\" rel=\"noopener noreferrer\">Bridge2Rwanda</a>, <a href=\"https://mastercardfdn.org/en/partners/inspire-educate-and-empower-iee-rwanda/\" target=\"_blank\" rel=\"noopener noreferrer\">Inspire Educator and Empower Rwanda (IEE)</a>, <a href=\"https://www.rainwatercharitablefoundation.org\" target=\"_blank\" rel=\"noopener noreferrer\">Rainwater Charitable Foundation</a>, <a href=\"https://www.mineduc.gov.rw\" target=\"_blank\" rel=\"noopener noreferrer\">Ministry of Education Rwanda</a>, and <a href=\"https://www.reb.gov.rw/\" target=\"_blank\" rel=\"noopener noreferrer\">Rwanda Basic Education Board (REB)</a>.",
    ...
    "footer-brand-desc": "Honore is a dedicated developer, teacher, ICT professional, student of Computer Science and Physics Education and Theology, discipleship mentor, and servant of God , who received salvation by God’s grace, not by works. He is passionate about transforming education through technology, empowering communities, and fulfilling Acts 1:8 and Matthew 28:19 through evangelism, discipleship, teaching, and Christ-centered service.",
    "footer-faq-title": "Frequently Asked Questions",
    "faq-q1": "How can I contact Honore for ICT training?",
    "faq-a1": "You can reach out via the <a href=\"contact.html\">Contact Page</a> or via email directly at tuyishimehonore63@gmail.com.",
  ...
  fr: {
    ...
    "prof-current": "Je sers actuellement comme enseignant à la <a href=\"https://rukaramodelschool.com/\" target=\"_blank\" rel=\"noopener noreferrer\">Rukara Model School of Sciences and Mathematics</a> et je suis étudiant en enseignement de l'informatique et de la physique à l'Université Indépendante de Kigali (<a href=\"https://ulk.ac.rw\" target=\"_blank\" rel=\"noopener noreferrer\">ULK</a>), campus de Gisenyi.",
    "prof-trainer": "Je travaille également comme formateur TIC chez <a href=\"https://www.pisquareltd.com/\" target=\"_blank\" rel=\"noopener noreferrer\">PiSquare</a> avec le soutien d'<a href=\"https://edify.org\" target=\"_blank\" rel=\"noopener noreferrer\">Edify</a>, où je forme des enseignants et des étudiants aux compétences numériques et à l'intégration technologique. De plus, je facilite le développement professionnel continu (CPD) dans mon école.",
    "prof-training": "J'ai participé à plusieurs formations professionnelles, notamment le programme pilote de résidence pour l'enseignement primaire (PTRP, <a href='https://www.mineduc.gov.rw/news-detail/primary-teacher-residency-pilot-program-for-ttcs-launched' target='_blank'>Lire plus</a>), facilité par l'<a href=\"https://www.fsu.edu\" target=\"_blank\">Université d'État de Floride</a>, <a href=\"https://bridge2rwanda.org\" target=\"_blank\">Bridge2Rwanda</a>, <a href=\"https://mastercardfdn.org/en/partners/inspire-educate-and-empower-iee-rwanda/\" target=\"_blank\">Inspire Educator and Empower Rwanda (IEE)</a>, la <a href=\"https://www.rainwatercharitablefoundation.org\" target=\"_blank\">Rainwater Charitable Foundation</a>, le <a href=\"https://www.mineduc.gov.rw\" target=\"_blank\">ministère de l'Éducation</a> du Rwanda et le <a href=\"https://www.reb.gov.rw/\" target=\"_blank\">Rwanda Basic Education Board (REB)</a>.",
    ...
    "footer-brand-desc": "Honore est un développeur, enseignant et professionnel des TIC dévoué, étudiant en informatique et en éducation physique et théologie, mentor en discipulat et serviteur de Dieu. Il est passionné par la transformation de l'éducation par la technologie, l'autonomisation des communautés et l'accomplissement d'Actes 1:8 et Matthieu 28:19 à travers l'évangélisation, l'enseignement et le service centré sur le Christ.",
    "footer-faq-title": "Questions Fréquemment Posées",
    "faq-q1": "Comment puis-je contacter Honore pour une formation en TIC ?",
    "faq-a1": "Vous pouvez nous contacter via la <a href=\"contact.html\">Page de Contact</a> ou par e-mail directement à tuyishimehonore63@gmail.com.",
